---
title: "MIT 20.440 Final Project: sncRNA transcriptomics as a predictive marker of Parkinson’s disease progression - all data analysis besides machine learning"
author: "Evan Collins and Brian Cheng"
date: "1 May 2023"
output: html_document
---

This R markdown document is best viewed and run in RStudio. Running each chunk will result in the production of all figures (besides those involving machine learning) as featured in our MIT 20.440 final project entitled *sncRNA transcriptomics as a predictive marker of Parkinson’s disease progression*.
...
pca_results_lda <- prcomp(sncrna_df_bl_t_pca[-which(cohort_bl_list == "SWEDD"), ], center = TRUE)
cumsum(pca_results_lda$sdev^2 / sum(pca_results_lda$sdev^2))
...
# Figure 3 - Differential expression analysis of sncRNAs between healthy, prodromal, and PD subjects at baseline
...
# optionally save
#ggsave("figures/subplots/fig3_volcano_bl_p_h.png", 
#       plot = volcano_bl_p_h,
#       width = 2500,
#       height = 3000,
#      units = "px")
...
# Figure 4 - Number of differentially expressed sncRNAs in PD and prodromal subjects varies by age
...
# optionally save
#ggsave("figures/subplots/fig4_age_plot.png", 
#       plot = age_plot,
#       width = 4500,
#       height = 1500,
#       units = "px")
...
# Figure 5 - SNORD48 is amplified in PD patients with worsening motor symptoms over time  
...
# optionally save
#ggsave("figures/subplots/fig5_updrs_imp_wor_line_plot.png", 
...
# optionally save
#ggsave("figures/subplots/fig5_volcano_wor_nc.png", 
#       plot = volcano_wor_nc,
#       width = 2500,
#       height = 3000,
#       units = "px")
